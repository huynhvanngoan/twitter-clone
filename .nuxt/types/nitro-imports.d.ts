declare global {
  ...
  const generateTokens: typeof import('../../server/utils/jwt')['generateTokens']
  ...
  const uploadImageToCloudinary: typeof import('../../server/utils/cloudinary')['uploadImageToCloudinary']
...
export { uploadImageToCloudinary } from '../../server/utils/cloudinary';
export { sendRefreshToken, decodeRefreshToken, decodeAccessToken, generateTokens } from '../../server/utils/jwt';