import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, computed, ref, provide, Suspense, nextTick, mergeProps, Transition, useSSRContext, resolveComponent, withCtx, createVNode, renderSlot, resolveDynamicComponent, openBlock, createBlock, toDisplayString, watch, Fragment, renderList, createTextVNode, createSlots, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import "devalue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderSuspense } from "vue/server-renderer";
import { HomeIcon } from "@heroicons/vue/24/solid";
import { PencilIcon, ChevronDownIcon, HashtagIcon, BellIcon, InboxIcon, BookmarkIcon, DocumentTextIcon, UserIcon, EllipsisHorizontalCircleIcon, MagnifyingGlassIcon, ChatBubbleOvalLeftEllipsisIcon, ArrowPathIcon, HeartIcon, ArrowUpOnSquareIcon } from "@heroicons/vue/24/outline";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CbjC2mS_.js").then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    component: () => import("./_nuxt/search-B-uz8Ib5.js").then((m) => m.default || m)
  },
  {
    name: "status-id",
    path: "/status/:id()",
    component: () => import("./_nuxt/_id_-DuViptFx.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-De65Rvsc.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-M8BhgI-o.js").then((r) => r.default || r));
